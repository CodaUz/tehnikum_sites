class Slider {
  ...
  setTransform = (_id, maxSlider) => {
    ...
    document.querySelector(`#${_id}TitleSlider`).style.transition =
      ".4s ease-in-out";
    if (this.pos[_id] === maxSlider) {
      document.querySelector(`#${_id}NextSlider`).style.width = "11.5vw";
      document.querySelector(`#${_id}NextSlider`).style.borderTop =
        "3px solid #000";
      document.querySelector(`#${_id}NextSlider`).style.borderBottom =
        "3px solid #000";
    }
    setTimeout(() => {
      document.querySelector(
        ...
        (this.pos[_id] * sliderMain.offsetWidth) / 17.7
      }rem)`;
      document.querySelector(
        `#${_id}NextSlider`
      ).style.transform = `translateX(${
