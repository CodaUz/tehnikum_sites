...
function listenPopups() {
    ...
    $('.openProgramForm').click(function () {
        ...
        $('div.sendForm[data-form-id="Program"]').removeClass('btn__purple')
    ...
    $('.openForm').click(function () {
        ...
        $('div.sendForm[data-form-id="Program"]').addClass('btn__purple')
        $('p.titleName').text('РЕШАЙСЯ')
...
async function initCourseData() {
    const first_date =  moment(`2022-04-18`, 'YYYY-MM-DD')
...
async function initCoursesInForm() {
    const COURSES_ID = [[14, 'graphicDesignDate'], [10, 'smmForBeginnersDate'], [9, 'smmDate']]
