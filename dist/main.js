...
/* harmony import */ var _scss_slick_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7441);
...
/* harmony import */ var _scss_utils_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5922);
/* harmony import */ var _scss_utils_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_scss_utils_scss__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _services_main_script_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1149);
/* harmony import */ var _services_main_script_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_services_main_script_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _services_seo_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3759);
/* harmony import */ var _services_seo_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_services_seo_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _services_utm_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(961);
/* harmony import */ var _services_utm_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_services_utm_js__WEBPACK_IMPORTED_MODULE_6__);
// Images
 // Styles
...
function listenFeedbackSliders() {
  ...
  var _iterator = _createForOfIteratorHelper(document.querySelectorAll('.section__feedbackBox__box')),
      _step;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (name && phone) {
              ...
              _iterator4 = _createForOfIteratorHelper(document.querySelectorAll(".input"));
              ...
              redisValue = "".concat(encryptName(name), "-").concat(phone.replace(/\D/g, ""), "-").concat(status, "-").concat(COURSE);
              WEBINAR_ID = +$('.footer__mainBox__formBox__datesBox__gridBox__box.active').data('id');
              WEBINAR_NAME = $('.footer__mainBox__formBox__datesBox__gridBox__box.active').data('name');
...
function sendForm() {
  var _iterator2 = _createForOfIteratorHelper(document.querySelectorAll(".sendForm")),
      _step2;
...
function getReviewsVideos() {
  var _iterator3 = _createForOfIteratorHelper(document.querySelectorAll('.getVideo')),
      _step3;
...
function initWebinarDates() {
  return _initWebinarDates.apply(this, arguments);
}

function _initWebinarDates() {
  _initWebinarDates = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var webinars, index, _iterator5, _step5, webinar;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch('https://api-webinar.tehnikum.school/api/get_webinars');

          case 3:
            webinars = _context2.sent;
            _context2.next = 6;
            return webinars.json();

          case 6:
            webinars = _context2.sent;
            webinars = webinars.filter(function (v) {
              return moment(v['data_start']) && moment(v['data_start']) >= moment() && v['course'] === COURSE;
            });
            webinars = webinars.map(function (v) {
            ...
            webinars.sort(function (a, b) {
              return a.time_start < b.time_start ? -1 : b.time_start < a.time_start ? 1 : 0;
            });
            index = 0;
            ...
            _iterator5 = _createForOfIteratorHelper(webinars);

            try {
              for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
                webinar = _step5.value;
                $('.footer__mainBox__formBox__datesBox__gridBox').append("\n                <div class=\"footer__mainBox__formBox__datesBox__gridBox__box ".concat(index === 0 ? 'active' : '', "\" data-id=\"").concat(webinar['id_webinar'], "\" data-name=\"").concat(webinar['date_start_text'], " ").concat(webinar['date_start_time'], "\">\n                    <p>").concat(webinar['date_start_text'], "<br> ").concat(webinar['date_start_time'], "</p>\n                </div>\n            "));
                index += 1;
              }
            } catch (err) {
              _iterator5.e(err);
          ...
          case 17:
            ...
            console.log('error initWebinarDates', _context2.t0.message);
