...
var images = importAll(__webpack_require__(4909));
...
"use strict";
/* harmony import */ var _images_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7209);
/* harmony import */ var _images_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_images_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _scss_app_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5279);
...
/* harmony import */ var _scss_utils_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5922);
/* harmony import */ var _scss_utils_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_scss_utils_scss__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _services_main_script_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1149);
/* harmony import */ var _services_main_script_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_services_main_script_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _services_seo_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3759);
/* harmony import */ var _services_seo_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_services_seo_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _services_utm_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(961);
/* harmony import */ var _services_utm_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_services_utm_js__WEBPACK_IMPORTED_MODULE_5__);
// Images
 // Styles
...
function listenSliders() {
  $('.sliderBox__sliderDots').each(function () {
    ...
    var children_length = $(".sliderBox__slider[data-id=\"".concat(id, "\"]")).children().length;
    var number_of_dots = (children_length + children_length % n) / n;
    ...
    for (var i = 0; i < number_of_dots; i++) {
      var $dot = $("<div>", {
        "data-number": i,
        "class": "sliderBox__sliderDots__dot ".concat(i === 0 ? 'active' : '')
      });
      $dot.click(function () {
        var number_dot = parseInt($(this).data('number'));
  ...
  var _iterator = _createForOfIteratorHelper(document.querySelectorAll('.sliderBox__slider')),
      _step;

  try {
    var _loop = function _loop() {
      var slider = _step.value;
      slider.addEventListener("swiped-right", function (event) {
        event.stopPropagation();
        event.preventDefault();
        console.log('swipe right');
        moveSlider(slider.getAttribute('data-id'), undefined, false);
      });
      slider.addEventListener("swiped-left", function (event) {
        event.stopPropagation();
        event.preventDefault();
...
function moveSlider(id) {
  var number_dot = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  var is_next = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;

  if (number_dot === undefined) {
    number_dot = $(".sliderBox__sliderDots[data-id=\"".concat(id, "\"]>.active")).data('number');
    var all_numbers = $(".sliderBox__sliderDots[data-id=\"".concat(id, "\"]")).children().length;
    number_dot = is_next ? all_numbers - 1 === number_dot ? 0 : number_dot + 1 : number_dot === 0 ? all_numbers - 1 : number_dot - 1;
    $(".sliderBox__sliderDots[data-id=\"".concat(id, "\"]>.active")).removeClass('active');
    $(".sliderBox__sliderDots[data-id=\"".concat(id, "\"]>.sliderBox__sliderDots__dot[data-number=\"").concat(number_dot, "\"]")).addClass('active');
  }

  $(".sliderBox__slider[data-id=\"".concat(id, "\"]")).children().each(function () {
    var number = number_dot * 100;
    var multiple_value = 100;
    var number_px = $(window).width() <= MOBILE_WIDTH ? 0 : number_dot * multiple_value;
    $(this).css('transform', "translateX( calc(-".concat(number, "% - ").concat(number_px, "px))"));
  });
}
...
function listenFeedbackSliders() {
  ...
  var _iterator2 = _createForOfIteratorHelper(document.querySelectorAll('.section__feedbackBox__box')),
      _step2;
...
function moveFeedbackSlider(number) {
  var isSlide = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var isNext = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;

  if (isSlide) {
    var maxIndex = $('.section__feedbackBox__sliderDots').children().length - 1;
    var index = parseInt($('.section__feedbackBox__sliderDots__dot.active').data('index'));
  ...
  var slideWidth = $('.section__feedbackBox').width();
  var addWidth = 15;
  var translateX = slideWidth * number + addWidth * number;
  $('.section__feedbackBox__sliderDots__dot').removeClass('active');
  $(".section__feedbackBox__sliderDots__dot[data-index=\"".concat(number, "\"]")).addClass('active');
  $('.section__feedbackBox__box').css('transform', "translateX( ".concat(translateX > 0 ? translateX * -1 : 0, "px)"));
}
...
function openModalForm(formName) {
  ...
  document.querySelector("".concat(formName, ">.grayBack")).classList.add("active");
  setTimeout(function () {
    document.querySelector(formName).classList.add("activeAnimate");
    document.querySelector("".concat(formName, ">.grayBack")).classList.add("activeAnimate");
  }, 0);
}

function closeModalForm(formName) {
  document.querySelector("".concat(formName, ">.grayBack")).classList.remove("activeAnimate");
  setTimeout(function () {
    document.querySelector(formName).classList.remove("activeAnimate");
    document.querySelector(formName).classList.remove("active");
    document.querySelector("".concat(formName, ">.grayBack")).classList.remove("active");
  }, 100);
}
...
function takeCourse(_x) {
  return _takeCourse.apply(this, arguments);
}

function _takeCourse() {
  _takeCourse = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(formId) {
    var is_redirect,
        name,
        phone,
        query,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            is_redirect = _args.length > 1 && _args[1] !== undefined ? _args[1] : false;
            name = document.querySelector("input[name=\"name".concat(formId, "\"]")).value;
            phone = document.querySelector("input[name=\"phone".concat(formId, "\"]")).value;
            query = window.location.search.substring(1);
            qs = parse_query_string(query);

            if (name && phone) {
              document.querySelector("input[name=\"name".concat(formId, "\"]")).value = "";
              document.querySelector("input[name=\"phone".concat(formId, "\"]")).value = "";
              _iterator5 = _createForOfIteratorHelper(document.querySelectorAll(".input"));
              ...
              redisKey = Math.floor(Math.random() * 900000000) + 100000000;
              redisValue = "".concat(encryptName(name), "-").concat(phone.replace(/\D/g, ""), "-").concat(status, "-tg");
              WEBINAR_ID = 604904;

              if (is_redirect) {
                fetch("https://node.snimerovsky.xyz/log", {
                  method: 'POST',
                  headers: {
                ...
                fetch("https://api.tehnikum.school/amocrm/?name=".concat(name, "&phone=").concat(phone.replace(/[ -]/g, ''), "&course=tg&action=program").concat(qs['r'] ? "&ref=".concat(qs['r']) : ''), {
                  method: "GET"
                });
                a = document.createElement('a');
                a.href = "https://t.me/TehnikumWebinarBot?start=".concat(WEBINAR_ID, "-send_smallchecklist").concat(qs.r ? "-".concat(qs.r) : '', "KEY").concat(redisKey);
                setTimeout(function () {
                  a.click();
                }, 500);
              } else {
                $(".footer__mainBox__formBox__readyBox[data-form-id=\"".concat(formId, "\"]")).addClass('active');
                $(".footer__formBox__discount[data-form-id=\"".concat(formId, "\"]")).css('display', 'none');
                fetch("https://node.snimerovsky.xyz/log", {
                  method: 'POST',
                  headers: {
                    'Accept': 'application/json',
                ...
                fetch("https://api.tehnikum.school/amocrm/?name=".concat(name, "&phone=").concat(phone, "&action=course&course=tg").concat(qs.r ? "-".concat(qs.r) : ''), {
                  method: "GET"
                });
              }
            }
...
function encryptName(name) {
  return "ENCRYPT" + _toConsumableArray(name).map(function (str) {
    return str.charCodeAt();
  }).join("S");
}

function sendForm() {
  var _iterator3 = _createForOfIteratorHelper(document.querySelectorAll(".sendForm")),
      _step3;
...
function setCountDown() {
  ...
  var eventTime = parseInt(localStorage.getItem('timeLeft'));
  ...
  setInterval(function () {
    ...
    if (duration.seconds() > 0) {
      $('.timeDays').text("".concat(days < 10 ? '0' : '').concat(days));
      $('.timeHours').text("".concat(hours < 10 ? '0' : '').concat(hours));
      $('.timeMinutes').text("".concat(minutes < 10 ? '0' : '').concat(minutes));
    }
  }, interval);
}
...
function openPopUp(formBox, grayBack, text, btnText, listener) {
  ...
  document.querySelector("".concat(formBox)).classList.add("active");
  document.querySelector("".concat(grayBack)).classList.add("active");
  POPUP_EVENT = listener;
  setTimeout(function () {
    document.querySelector("".concat(grayBack)).classList.add("activeAnimate");
    document.querySelector("".concat(formBox)).classList.add("activeAnimate");
  }, 0);
}

function getReviewsVideos() {
  var _iterator4 = _createForOfIteratorHelper(document.querySelectorAll('.getVideo')),
      _step4;
  ...
  document.querySelector('.grayBackVideo').addEventListener('click', function (e) {
...
var Seo = function Seo() {
  ...
  this.init = function () {
    _this.formData.append("action", "get_by_field");

    _this.formData.append("token", "123");

    _this.formData.append("value", "".concat(window.location.pathname));
  ...
  this.getApi = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://api.tehnikum.school/seo_page_info.php", {
              method: "POST",
              body: _this.formData
            });
  ...
  this.setSeoData = function (data) {
    if (data.title) {
      _this.renderTitle(data.title);
    }

    if (data.meta_description) {
      _this.renderMeta(data.meta_description, "description");
    }

    if (data.meta_keywords) {
      _this.renderMeta(data.meta_keywords, "keywords");
    }

    if (data.og_type) {
      _this.renderOg(data.og_type, "og:type");
    }

    if (data.og_site_name) {
      _this.renderOg(data.og_site_name, "og:site_name");
    }

    if (data.og_title) {
      _this.renderOg(data.og_title, "og:title");
    }

    if (data.og_description) {
      _this.renderOg(data.og_description, "og:description");
    }

    if (data.og_url) {
      _this.renderOg(data.og_url, "og:url");
    }

    if (data.og_locale) {
      _this.renderOg(data.og_locale, "og:locale");
    }

    if (data.og_image) {
      _this.renderOg(data.og_image, "og:image");
    }

    if (data.og_image_width) {
      _this.renderOg(data.og_image_width, "og:image:width");
    }

    if (data.og_image_height) {
      _this.renderOg(data.og_image_height, "og:image:height");
    }
  };

  this.renderTitle = function (data) {
    ...
    _this.head.appendChild(title);
  };

  this.renderMeta = function (data, name) {
    if (document.querySelector("head>meta[name='".concat(name, "']")) !== null) {
      document.querySelector("head>meta[name='".concat(name, "']")).remove();
    }

    var meta = document.createElement("meta");
    meta.name = "".concat(name);
    meta.content = data;

    _this.head.appendChild(meta);
  };

  this.renderOg = function (data, name) {
    if (document.querySelector("head>meta[property='".concat(name, "']")) !== null) {
      document.querySelector("head>meta[property='".concat(name, "']")).remove();
    }

    var meta = document.createElement("meta");
    meta.setAttribute("property", "".concat(name));
    meta.content = data;
...
var wks = __webpack_require__(2190);
var wksExt = __webpack_require__(9669);
var wksDefine = __webpack_require__(5648);
...
__webpack_require__(5648)('asyncIterator');
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/aboutUs.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/icon_database.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/icon_python.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/icon_youtube.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_diplom.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_hh.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_memoji_01.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_memoji_01.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_memoji_02.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_memoji_02.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_memoji_03.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_memoji_03.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_memoji_04.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_memoji_04.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_python.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pic_student-box.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pointer active.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/pointer.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/polygon.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/slider_image_01.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/slider_image_02.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/slider_image_03 (1).png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/slider_image_04.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/slider_image_05.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/speaker.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/student1.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/student2.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/student3.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/thanks.png");
...
;(function (global, factory) {
    true ? factory(__webpack_require__(1320)) :
   0
...
var map = {
	"./Logo.svg": 5606,
	"./aboutUs.png": 6089,
	"./icon_database.svg": 3904,
	"./icon_game_bot.svg": 5660,
	"./icon_python.svg": 6769,
	"./icon_youtube.svg": 1800,
	"./pic_diplom.png": 414,
	"./pic_hh.png": 445,
	"./pic_memoji_01.png": 6081,
	"./pic_memoji_01.svg": 170,
	"./pic_memoji_02.png": 7790,
	"./pic_memoji_02.svg": 1005,
	"./pic_memoji_03.png": 3655,
	"./pic_memoji_03.svg": 8758,
	"./pic_memoji_04.png": 9994,
	"./pic_memoji_04.svg": 7312,
	"./pic_python.svg": 5628,
	"./pic_student-box.png": 7289,
	"./pointer active.png": 4059,
	"./pointer.png": 2575,
	"./polygon.svg": 2439,
	"./slider_image_01.png": 6589,
	"./slider_image_02.png": 3660,
	"./slider_image_03 (1).png": 3542,
	"./slider_image_04.png": 7386,
	"./slider_image_05.png": 7246,
	"./speaker.png": 1693,
	"./speakerIcon1.svg": 6372,
	"./speakerIcon2.svg": 7057,
	"./speakerIcon3.svg": 2103,
	"./speakerIcon4.svg": 4324,
	"./student1.png": 2918,
	"./student2.png": 2785,
	"./student3.png": 6294,
	"./thanks.png": 4266
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [532], () => (__webpack_require__(1208)))
